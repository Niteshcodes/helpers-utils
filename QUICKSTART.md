# Getting Started with @helpers/utils

Welcome to @helpers/utils! This quick start guide will help you get up and running.
...
import { toCamelCase, chunk, deepClone } from '@helpers/utils';
...
```typescript
// Check the type
import { isBool, isEmail } from '@helpers/utils';
...
```typescript
import { isString, isArray, isEmpty } from '@helpers/utils';
...
```typescript
import { toCamelCase, toSnakeCase, slugify } from '@helpers/utils';
...
```typescript
import { round, clamp, random, factorial } from '@helpers/utils';
...
```typescript
import { addDays, format, getAge } from '@helpers/utils';
...
```typescript
import { isStrongPassword, isCreditCard, isUuid } from '@helpers/utils';
...
```typescript
import { getQueryParam, setClipboard } from '@helpers/utils';
...
import { sendSuccess, sendError, validateRequired } from '@helpers/utils';
...
### Data Transformation
```typescript
import { pick, toCamelCase, deepClone } from '@helpers/utils';
...
### Form Validation
```typescript
import { isEmail, isStrongPassword } from '@helpers/utils';
